        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li style="padding: 10px 0 0;">
                        <a href="employee-screen.html" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Employee</span></a>
                    </li>
                    <li style="padding: 10px 0 0;">
                        <a href="table-screen.html" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Table</span></a>
                    </li>
                    <li style="padding: 10px 0 0;">
                        <a href="food-screen.html" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-danger">26</h3>
                                </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="txt-oflo">Taylor swift</td>
                                            <td>Complete</td>
                                            <td class="txt-oflo">April 18</td>
                                            <td><span class="text-success">$24</span></td>
                                        </tr>
                                        <tr>
                                            <td class="txt-oflo">Joe Biden</td>
                                            <td>Cancel</td>
                                            <td class="txt-oflo">April 19</td>
                                            <td><span class="text-info">$1250</span></td>
                                        </tr>
                                        <tr>
                                            <td class="txt-oflo">Harry Potter</td>
                                            <td>Processing</td>
                                            <td class="txt-oflo">April 20</td>
                                            <td><span class="text-danger">$24</span></td>
                                        </tr>
                                        <tr>
                                            <td class="txt-oflo">Selena Gomez</td>
                                            <td>Processing</td>
                                            <td class="txt-oflo">April 21</td>
                                            <td><span class="text-success">$24</span></td>
                                        </tr>
                                        <tr>
                                            <td class="txt-oflo">Mark Zuckerberg</td>
                                            <td>Complete</td>
                                            <td class="txt-oflo">April 22</td>
                                            <td><span class="text-success">$24</span></td>
                                        </tr>
                                        <tr>
                                            <td class="txt-oflo">Sam</td>
                                            <td>Processing</td>
                                            <td class="txt-oflo">April 23</td>
                                            <td><span class="text-danger">$14</span></td>
                                        </tr>
                                        <tr>
                                            <td class="txt-oflo">Olivia Rodrigo</td>
                                            <td>Cancel</td>
                                            <td class="txt-oflo">April 22</td>
                        ...
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <a href="#">
                                    ...
                                    <div class="mail-contnet">
                                        <h5>Pavan kumar</h5> <span class="mail-desc">At table 11</span> <span
                                ...
                                <a href="#">
                                    ...
                                    <div class="mail-contnet">
                                        <h5>Sonu Nigam</h5> <span class="mail-desc">At table 42</span>
                                ...
                                <a href="#">
                                    ...
                                    <div class="mail-contnet">
                                        <h5>Arijit Sinh</h5> <span class="mail-desc">At table 23</span> <span
                                ...
                                <a href="#">
                                    ...
                                    <div class="mail-contnet">
                                        <h5>Genelia Deshmukh</h5> <span class="mail-desc">Delivery</span> <span class="time">9:08 AM</span>
                                    </div>
                                </a>
                                <a href="#" class="b-none">
                                    <div class="user-img"> <img src="../plugins/images/users/pawandeep.jpg" alt="user"
                                    ...
                                    <div class="mail-contnet">
                                        <h5>Pavan kumar</h5> <span class="mail-desc">At table 14</span> <span
