$(document).ready(function () {
    ...
    $('.click-to-fill-form-food').click(function (e) {
        var formFields = [];
        var $target = $(event.target);
        var $row = $target.closest('tr');
        $row.find('td').each(function (index, el) {
            ...
            switch (index) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    formFields['Quantity'] = fieldValue;
                    break;
                case 3:
                    formFields['Status'] = fieldValue;
                    break;
                case 4:
                    formFields['Price'] = fieldValue;
                    break;
                default:
                    break;
            }
        ...
        fillFormFoods(formFields);
    });

    function fillFormFoods(data) {
        var $form = $('#food-update');
        $form.find('input').each(function () {
            var $input = $(this);
            switch ($input.attr("name")) {
                case 'id':
